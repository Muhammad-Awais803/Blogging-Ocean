...
import FiltersComponent from "../dashboard/filtersComponent/page";

const DashboardBlogsForm = () => {
  return (
    <div className=" w-full flex flex-col mx-2 pt-10 gap-5">
      <DashboardHeading heading={"Blogs"}/>
      <div className="flex items-center gap-2">
        <FiltersComponent heading={"Categories"} />
        <FiltersComponent heading={"Categories"} />
        <FiltersComponent heading={"Tags"} />
      </div>

    <div class="relative overflow-x-auto shadow-md w-full bg-red-500 sm:rounded-lg">
...
export default DashboardBlogsForm
